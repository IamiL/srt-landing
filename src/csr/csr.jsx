...
import {TimerProvider} from "../components/timerContext/timerContext.jsx";
                ...
                <BrowserRouter basename={enLan ? '/en' : ''}>
                    ...
                    <Routes>
                        <Route
                                exact
                                path="/"
                                element={<HomePageCsr enLan={enLan} />}
                        />
                        <Route
                                exact
                                path="/cases"
                                element={<Cases enLan={enLan} />}
                        />
                        <Route
                                exact
                                path="/manufacturing"
                                element={<Manufacturing enLan={enLan} />}
                        />
                        <Route
                                exact
                                path="/catalog"
                                element={<CatalogPage enLan={enLan} />}
                        />
                        <Route
                                exact
                                path="/catalog/rotary-crusher"
                                element={<RotaryCrusher enLan={enLan} />}
                        />
                        <Route
                                exact
                                path="/catalog/isolators"
                                element={<Isolators enLan={enLan} />}
                        />
                        <Route
                                exact
                                path="/catalog/drying-cabinets"
                                element={<DryingCabinetsPage enLan={enLan} />}
                        />
                        <Route
                                exact
                                path="/policy"
                                element={<PrivacyPolicy enLan={enLan} />}
                        />
                    </Routes>
                    <Footer enLan={enLan} />
