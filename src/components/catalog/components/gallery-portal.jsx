...
export default function GalleryPortal({catalogNumber, item, isOpen, setIsOpen}) {
    ...
    return createPortal(
            <div
                    className={`catalog-modal-wrapper catalog-modal-wrapper-gallery ${isOpen === null ? '' : isOpen ? 'catalog-modal-wrapper-gallery-open catalog-modal-wrapper-open' : 'catalog-modal-wrapper-close'}`}
            ...
            >
                ...
                {(item !== 0) && <div
                        ref={ref}
                        className={'catalog-modal-gallery'}
                >
                    <button
                            className='catalog-modal-close-button'
                            onClick={() => {
                                setIsOpen(false);
                                document.body.style.overflow = "visible";
                            }}
                    ...
                    <div className='fullscreen-img'>
                        {
                            (catalogNumber === 0 && item === 5) ?
                                    <video
                                            ...
                                            controls
                                            height="100%"
                                            className="fullscreen-img-image"
                                    >
                                        <source
                                                src={"/video.mp4"}
                                                type="video/mp4"
