...
import './contacts.css'
import FeedbackBlock from "../feedbackBlock/FeedbackBlock.jsx";
...
export default function Contacts({enLan}) {
    return <section id="contacts">
        ...
        <div className='contacts_block-contacts_list'>
            <p
                    className="text2"
                    id={styles.text2}
            >
                {enLan ? 'We offer opportunities for specialists eager to grow and develop in digital technologies. Regardless of your location, if you have the knowledge and ambition, we’d be delighted to have you on our team. We provide opportunities for training, development, and competitive compensation.' :
                        <>
                            Мы предлагаем сотрудничество<br className="brt4" /> специалистам, которые<br className="brt5" /> хотят<br /> расти и<br className="brt4" /> развиваться в области
                            цифровых<br className="brt5" /> технологий. Если у<br className="brt1" /> вас есть знания и амбиции,<br className="brt4" /> независимо<br className="brt5" /> от
                            вашего<br className="brt1" /> местоположения, мы будем рады видеть вас в нашей<br className="brt1" /> команде. Мы предлагаем возможности для<br
                                className="brt5"
                        /> обучения,<br
                                className="brt6"
                        /> развития
            ...
            <div id={styles.contacts_list}>
                ...
                >
                    <svg
                            className='contactsBlock-contactsList-icon'
                ...
                <a
                        href='https://api.whatsapp.com/send/?phone=79276573030'
                        className='contactsBlock-contactsList-contact-item'
                >
                    <svg
                            className='contactsBlock-contactsList-icon'
